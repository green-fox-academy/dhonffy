...
void draw(SDL_Renderer *gRenderer)
{
    ...
    for (int i = 0; i < 4; ++i) {
        ...
        SDL_RenderDrawLine(gRenderer, (x1 + i * 60), (y1 + i * 80) + (a + i * 12), (x1 + i * 60) + (b + i * 10), (y1 + i * 80) + (a + i * 12));
        SDL_RenderDrawLine(gRenderer, (x1 + i * 60) + (b + i * 10), (y1 + i * 80) + (a + i * 12), (x1 + i * 60) + (b + i * 10), (y1 + i * 80));
